...
const CreatePost = () => {
  ...
  const handleSurpriseMe = () => {
    ...
    setForm( f => ({...f, prompt: randomPrompt }))
  }
  ...
  return (
   <section className="max-w-7xl mx-auto">
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
          Create imaginative and visually stunning images through Nemesis AI and share them with the community
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
              ...
              rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
                  ...
                  {generatingImg && (
                    <div className="absolute inset-0 z-0 flex justify-center items-center bg-slate-800/60 rounded-lg">
                      <Loader />
                    </div>
                  )}
              </div>
